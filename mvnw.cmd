...
if (-not $env:MVNW_REPOURL) {
  ...
  Write-Verbose "MVNW_REPOURL not set, defaulting to Aliyun Maven mirror: $env:MVNW_REPOURL"
}

if ($env:MVNW_REPOURL) {
  $MVNW_REPO_PATTERN = if ($USE_MVND) { "/maven/mvnd/" } else { "/org/apache/maven/" } # Corrected pattern logic
